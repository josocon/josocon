...
(async ({document, window, navigator, location, fetch, console, alert, Notification, URL, FormData, MutationObserver, DOMParser, HTMLElement, URLSearchParams, markdownit, Object, history, customElements}) => {
